...
# what type of piece it is and whether or
# not it can be killed by another selected piece.
...
bp = Piece('b', 'p', 'pieces/pawn_b.png')
wp = Piece('w', 'p', 'pieces/pawn_w.png')
bk = Piece('b', 'k', 'pieces/king_b.png')
wk = Piece('w', 'k', 'pieces/king_w.png')
br = Piece('b', 'r', 'pieces/rook_b.png')
wr = Piece('w', 'r', 'pieces/rook_w.png')
bb = Piece('b', 'b', 'pieces/bishop_b.png')
wb = Piece('w', 'b', 'pieces/bishop_w.png')
bq = Piece('b', 'q', 'pieces/queen_b.png')
wq = Piece('w', 'q', 'pieces/queen_w.png')
bkn = Piece('b', 'kn', 'pieces/knight_b.png')
wkn = Piece('w', 'kn', 'pieces/knight_w.png')
...
def create_board(board):
    board[0] = [
        Piece('b', 'r', 'pieces/rook_b.png'),
        Piece('b', 'kn', 'pieces/knight_b.png'),
        Piece('b', 'b', 'pieces/bishop_b.png'),
        Piece('b', 'q', 'pieces/queen_b.png'),
        Piece('b', 'k', 'pieces/king_b.png'),
        Piece('b', 'b', 'pieces/bishop_b.png'),
        Piece('b', 'kn', 'pieces/knight_b.png'),
        Piece('b', 'r', 'pieces/rook_b.png')
    ]
    ...
    board[7] = [
        Piece('w', 'r', 'pieces/rook_w.png'),
        Piece('w', 'kn', 'pieces/knight_w.png'),
        Piece('w', 'b', 'pieces/bishop_w.png'),
        Piece('w', 'q', 'pieces/queen_w.png'),
        Piece('w', 'k', 'pieces/king_w.png'),
        Piece('w', 'b', 'pieces/bishop_w.png'),
        Piece('w', 'kn', 'pieces/knight_w.png'),
        Piece('w', 'r', 'pieces/rook_w.png')
    ]
    ...
    for i in range(8):
        board[1][i] = Piece('b', 'p', 'pieces/pawn_b.png')
...
# for pieces of the opposite team.
...
def make_grid(rows, width):
    """
    Creates the chess tiles
    I've put them into a 2d array
    identical to the dimesions of the chessboard
    """
    grid = []
    gap = WIDTH // rows
    print(gap)
...
def draw_grid(win, rows, width):
    """
    Draws the grey lines that separate
...
def remove_highlight(grid):
    """
    grid: 2 co-ordinate parameters which you can get as the position
    of the piece and then the position of the node it is moving to
